...
!(function(s) {
  ...
  ;(p = undefined),
    ...
    (function(t) {
      ...
      return (function s(o, a, u) {
        ...
        for (var l = 'function' == typeof v && v, t = 0; t < u.length; t++)
          c(u[t])
        return c
      })(
        {
  ...
  function F(t) {
    return t.style.marginTop &&
      ...
      ? Pt(t.style.marginTop)
      : ''
  }
  function M(t) {
    return t.style.borderWidth ? Pt(t.style.borderWidth) : ''
  }
  function k(t, e) {
  ...
  function G(t) {
    z(t)
      ? (function(t) {
          var e = t.parentNode
          Ht.insertAfter(t, e), Ht.remove(e)
        })(t)
      : (function(t) {
          var e = Ht.create('figure', { class: 'image' })
          Ht.insertAfter(e, t),
            e.appendChild(t),
            e.appendChild(
              Ht.create('figcaption', { contentEditable: 'true' }, 'Caption')
            ),
  ...
  function V(t, e) {
    return t.style[e] ? Pt(t.style[e]) : k(t, e)
  }
  function X(t, e) {
    var n = Lt(e)
  ...
  function Z(t) {
    return (
      0 === Ht.getAttrib(t, 'alt').length &&
      'presentation' === Ht.getAttrib(t, 'role')
    )
  }
  function Q(t, e) {
    ...
    return (
      B(n, 'style', e.style),
      (!j(n) && '' === e.hspace) || X(n, e.hspace),
      (!F(n) && '' === e.vspace) || $(n, e.vspace),
      (!M(n) && '' === e.border) || J(n, e.border),
      (!(function(t) {
  ...
  function at(e, t, n) {
    var r = (function(t, e, n) {
      ...
      if (
        (Bt(t, I(I({}, e), { caption: !1 }), r, n),
        zt(r, e.alt, e.isDecorative, n),
        e.caption)
      ) {
        var i = Ht.create('figure', { class: 'image' })
        return (
          i.appendChild(r),
          i.appendChild(
            Ht.create('figcaption', { contentEditable: 'true' }, 'Caption')
    ...
    e.dom.setAttrib(r, 'data-mce-id', '__mcenew'),
      e.focus(),
      e.selection.setContent(r.outerHTML)
    var i = e.dom.select('*[data-mce-id="__mcenew"]')[0]
    if ((e.dom.setAttrib(i, 'data-mce-id', null), K(i))) {
      var o = ot(e, i)
      ...
      ? e.src
        ? (function(e, t, n) {
            ...
            if (
              ...
              var i = r.parentNode
              ot(e, i), e.selection.select(r.parentNode)
  ...
  var st,
    ...
    Dt =
      ...
      function() {
        ...
        for (var n = {}, r = 0; r < t.length; r++) {
          var i = t[r]
          for (var o in i) _t.call(i, o) && (n[o] = st(n[o], i[o]))
        }
        return n
      }),
    At =
      (s.Node.ATTRIBUTE_NODE,
      s.Node.CDATA_SECTION_NODE,
      s.Node.COMMENT_NODE,
      s.Node.DOCUMENT_NODE,
      s.Node.DOCUMENT_TYPE_NODE,
      s.Node.DOCUMENT_FRAGMENT_NODE,
      s.Node.ELEMENT_NODE,
      s.Node.TEXT_NODE,
      s.Node.PROCESSING_INSTRUCTION_NODE,
      s.Node.ENTITY_REFERENCE_NODE,
      s.Node.ENTITY_NODE,
      s.Node.NOTATION_NODE,
      'undefined' != typeof s.window ? s.window : Function('return this;')(),
      function(t) {
    ...
    Et = {
      fromHtml: function(t, e) {
        var n = (e || s.document).createElement('div')
        if (((n.innerHTML = t), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (s.console.error('HTML does not have a single root node', t),
          new Error('HTML must have a single root node'))
        return At(n.childNodes[0])
      },
      fromTag: function(t, e) {
        var n = (e || s.document).createElement(t)
        return At(n)
      },
      fromText: function(t, e) {
        var n = (e || s.document).createTextNode(t)
        return At(n)
      },
      fromDom: At,
      fromPoint: function(t, e, n) {
        var r = t.dom()
        return w.from(r.elementFromPoint(e, n)).map(At)
      },
    },
    Nt = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    Ot = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    Ut = tinymce.util.Tools.resolve('tinymce.util.XHR'),
    It = function(t) {
    ...
    Ct = {
      ...
      showAccessibilityOptions: function(t) {
        return t.getParam('a11y_advanced_options', !1, 'boolean')
      },
      isAutomaticUploadsEnabled: function(t) {
    ...
    St = function(t, e) {
      ...
      ;(r.onload = function() {
        var t = {
          width: R(r.width, r.clientWidth),
          height: R(r.height, r.clientHeight),
        }
        n(yt.value(t))
      }),
        (r.onerror = function() {
    ...
    zt = function(t, e, n, r) {
      if (n) {
        Ht.setAttrib(t, 'role', 'presentation')
        var i = Et.fromDom(t)
        L(i, 'alt', '')
      } else {
        if (r.hasAccessibilityOptions) Ht.setAttrib(t, 'alt', e)
        else {
          i = Et.fromDom(t)
          L(i, 'alt', e)
        }
    ...
    Bt = function(t, e, n, r) {
      var i = tt(t, n)
      et(n, i, e, 'caption', function(t, e, n) {
        return G(t)
      }),
        et(n, i, e, 'src', B),
        et(n, i, e, 'title', B),
        et(n, i, e, 'width', q(0, t)),
        et(n, i, e, 'height', q(0, t)),
        et(n, i, e, 'class', B),
        et(
          n,
          i,
        ...
        et(n, i, e, 'hspace', nt(X, t)),
        et(n, i, e, 'vspace', nt($, t)),
        et(n, i, e, 'border', nt(J, t)),
        et(n, i, e, 'borderStyle', nt(Y, t)),
        (function(t, e, n, r) {
          ;(n.alt === e.alt && n.isDecorative === e.isDecorative) ||
            zt(t, n.alt, n.isDecorative, r)
        })(n, i, e, r)
    },
    Gt = tinymce.util.Tools.resolve('tinymce.util.Tools'),
    Wt = function(t, i) {
      var o = []
      return (
  ...
  function Jt(a) {
    ...
    return (
      (a = Gt.extend({ credentials: !1, handler: e }, a)),
      {
        upload: function(t) {
          return !a.url &&
            (function(t) {
            ...
            ? Ot.reject('Upload url missing from the settings.')
            : (function(r, i) {
                return new Ot(function(t, e) {
                  try {
                    i(r, t, e, o)
    ...
    var r = Vt(function(t) {
      ...
      t = gt(function(e) {
        jt(n, function(t) {
          e(
            r(t).map(function(t) {
              return T([[{ text: 'None', value: '' }], t])
            })
          )
        })
      }),
      e = Xt(Ct.getClassList(n)),
      i = Ct.hasAdvTab(n),
      o = Ct.hasUploadTab(n),
      a = Ct.hasUploadUrl(n),
      ...
      m = Ct.showAccessibilityOptions(n),
      p = Ct.getUploadUrl(n),
      g = Ct.getUploadBasePath(n),
      h = Ct.getUploadCredentials(n),
      v = Ct.getUploadHandler(n),
      b = Ct.isAutomaticUploadsEnabled(n),
  ...
  function Kt(t) {
    var e = t.imageList.map(function(t) {
      ...
      n = {
        ...
        disabled: t.hasAccessibilityOptions && t.image.isDecorative,
      },
      r = t.classList.map(function(t) {
        return { name: 'classes', type: 'selectbox', label: 'Class', items: t }
      })
    return T([
      [{ name: 'src', type: 'urlinput', filetype: 'image', label: 'Source' }],
      e.toArray(),
      t.hasAccessibilityOptions && t.hasDescription
        ? [
            {
              type: 'label',
              label: 'Accessibility',
  ...
  function ee(t, e) {
    ...
    if (r !== undefined) {
      var i = Dt({}, n)
      !(function(t, e, n) {
        t.hasDescription && _(n.alt) && (e.alt = n.alt),
          t.hasAccessibilityOptions &&
            (e.isDecorative = n.isDecorative || e.isDecorative || !1),
          t.hasImageTitle && _(n.title) && (e.title = n.title),
          t.hasDimensions &&
            (_(n.width) && (e.dimensions.width = n.width),
            _(n.height) && (e.dimensions.height = n.height)),
          _(n['class']) &&
            $t(t.classList, n['class']).each(function(t) {
              e.classes = t.value
            }),
          t.hasImageCaption && A(n.caption) && (e.caption = n.caption),
          t.hasAdvTab &&
            (_(n.style) && (e.style = n.style),
            _(n.vspace) && (e.vspace = n.vspace),
            _(n.border) && (e.border = n.border),
            _(n.hspace) && (e.hspace = n.hspace),
            _(n.borderstyle) && (e.borderstyle = n.borderstyle))
      })(t, i, r),
        e.setData(i)
    }
  }
    ...
    return (
      ...
      (i.hspace = (function(t) {
        return t['margin-right'] &&
          ...
          ? Pt(String(t['margin-right']))
          : ''
      })(r)),
      (i.border = (function(t) {
        return t['border-width'] ? Pt(String(t['border-width'])) : ''
      })(r)),
  ...
  function ie(u, c, e, l) {
    ...
    l.block('Uploading image'),
      (function(t) {
        ...
        function(n) {
          function r() {
            l.unblock(), s.URL.revokeObjectURL(o)
          }
          function i(t) {
          ...
          Mt(n).then(function(t) {
            var e = u.createBlobCache(n, o, t)
            c.automaticUploads
              ? a
                  .upload(e)
                  .then(function(t) {
              ...
              : (u.addToBlobCache(e), i(e.blobUri()), l.unblock())
          })
        }
      )
  }
  function oe(n, r, i) {
    return function(t, e) {
      'src' === e.name
        ...
        ? (function(t, e) {
            var n = e.getData(),
              r = re(t.parseStyle, t.serializeStyle, n)
            e.setData(r)
          })(n, t)
        : 'vspace' === e.name ||
          'hspace' === e.name ||
          ...
          'borderstyle' === e.name
        ? (function(t, e, n) {
            var r = Dt(Zt(e.image), n.getData()),
              i = Q(t.normalizeCss, Qt(r))
            n.setData({ style: i })
          })(n, r, t)
        : 'fileinput' === e.name
        ? ie(n, r, i, t)
        : 'isDecorative' === e.name &&
          (t.getData().isDecorative ? t.disable('alt') : t.enable('alt'))
    }
  }
  function ae(n) {
    return function(t) {
      ...
      imageSize: (function(e) {
        return function(t) {
          return wt(function(n) {
            St(e.documentBaseURI.toAbsolute(t), function(t) {
  ...
  var le = function(t) {
    ...
    se = function(t) {
      return { title: 'General', name: 'general', items: Kt(t) }
    },
    fe = Kt,
    de = function(t) {
      return {
    ...
    me = function(t) {
      t.addCommand('mceImage', ue(t).open)
    },
    pe = function(t) {
      t.on('PreInit', function() {
        t.parser.addNodeFilter('figure', ce(!0)),
          t.serializer.addNodeFilter('figure', ce(!1))
      })
    },
    ge = function(e) {
