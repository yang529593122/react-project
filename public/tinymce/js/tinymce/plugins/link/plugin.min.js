...
!(function(c) {
  ...
  var e,
    ...
    b = function(n) {
      return n.getParam('link_default_protocol', 'http', 'string')
    },
    _ = function(n) {
    ...
    var e,
      ...
      u = function(n) {
        return n.filter(function(n) {
          return -1 === tn.inArray(o, n)
        })
      },
      c = t ? (0 < (e = u((e = i))).length ? e.concat(o) : o) : u(i)
    return 0 < c.length ? ((r = c), tn.trim(r.sort().join(' '))) : ''
  }
  function M(n, t) {
    return (
      (t = t || n.selection.getNode()),
      en(t) ? n.dom.select('a[href]', t)[0] : n.dom.getParent(t, 'a[href]')
    )
  }
  function z(n) {
    return n && 'A' === n.nodeName && !!D(n)
  }
  function q(n) {
  ...
  function K(n, t) {
    var e = T({}, t)
    if (!(0 < v(n).length) && !1 === k(n)) {
      var r = U(e.rel, '_blank' === e.target)
      e.rel = r || null
    }
    return (
      Q.from(e.target).isNone() && !1 === g(n) && (e.target = p(n)),
      (e.href = (function(n, t) {
        return ('http' !== t && 'https' !== t) || R(n) ? n : t + '://' + n
      })(e.href, d(n))),
      e
    )
  }
  ...
  function V(t) {
    return (
      void 0 === t && (t = B),
      function(n) {
        return Q.from(n).map(function(n) {
          return (function(n, r) {
            var o = []
            return (
              tn.each(n, function(n) {
    ...
    return o !== undefined
      ? (function(t, n) {
          return L(n, function(n) {
            return Q.some(n).filter(function(n) {
              return n.value === t
            })
          })
        })(o, e).map(function(n) {
  ...
  var H,
    ...
    Q = {
      ...
      none: t,
      from: function(n) {
        return null === n || n === undefined ? C : X(n)
      },
    },
                ...
                if (o.get().length <= 0) {
                  var t =
                      n.url.meta.text !== undefined
                        ? n.url.meta.text
                        : n.url.value,
                    e = n.url.meta.title !== undefined ? n.url.meta.title : ''
                  return Q.some({ text: t, title: e })
                }
                return Q.none()
              })(n())
            : I(['anchor', 'link'], t.name)
            ? e(n(), t)
            : ('text' === t.name && o.set(n().text), Q.none())
        },
      }
    },
    yn = {},
  ...
  ;(H = undefined),
    ...
    (function(n) {
      ...
      return (function l(i, u, c) {
        ...
        for (var f = 'function' == typeof J && J, n = 0; n < c.length; n++)
          a(c[n])
        return a
      })(
        {
  ...
  function bn(n, t, e) {
    ...
    return null !== r && 0 < r.length ? Q.some(r) : Q.none()
  }
  function _n(n, t) {
    return n.dom.getParent(t, 'a[href]')
  }
  function Tn(n) {
    return _n(n, n.selection.getStart())
  }
  function On(n, t) {
    if (t) {
      var e = fn(t)
  ...
  var An = wn.exports.boltExport,
    ...
    Sn = tinymce.util.Tools.resolve('tinymce.util.Delay'),
    jn = function(n, r) {
      return L(
        [
          xn,
        ...
        function(e) {
          return En(function(t) {
            !(function(t, n, e) {
              ...
              Sn.setEditorTimeout(t, function() {
    ...
    Fn = function(n) {
      ...
      return 0 < e.length
        ? Q.some([{ text: 'None', value: '' }].concat(e))
        : Q.none()
    },
    Ln = function(n) {
      var t = y(n)
      return 0 < t.length ? pn.sanitize(t) : Q.none()
    },
    Rn = tinymce.util.Tools.resolve('tinymce.util.XHR'),
    Dn = function(t) {
      function e(n) {
    ...
    qn = function(e, r) {
      return Dn(e).map(function(n) {
        var t = (function(n, t) {
          var e = n.dom,
            r = ln(n.selection.getContent())
              ? Q.some(dn(n.selection, t))
              : Q.none(),
            o = t ? Q.some(e.getAttrib(t, 'href')) : Q.none(),
            i = t ? Q.from(e.getAttrib(t, 'target')) : Q.none(),
            u = bn(e, t, 'rel'),
            c = bn(e, t, 'class')
          return {
            url: o,
        ...
        .map(function(n) {
          return (function(n, t, e) {
              ...
              body: {
                ...
                items: j([
                  ...
                  (function(n) {
                    ...
                    c.anchor.map(pn.createUi('anchor', 'Anchors')),
                    c.rels.map(pn.createUi('rel', 'Rel')),
                    c.targets.map(pn.createUi('target', 'Open link in...')),
                    c.link.map(pn.createUi('link', 'Link list')),
                    c.classes.map(pn.createUi('linkClass', 'Class')),
                  ]),
                ]),
              },
              buttons: [
            ...
            (function(i, u) {
              return function(n) {
                var e = n.getData()
                if (!e.url.value) return cn(i), void n.close()
                function t(t) {
                  return Q.from(e[t]).filter(function(n) {
    ...
    Wn = function(e) {
      e.on('click', function(n) {
        var t = _n(e, n.target)
        t && o.metaKeyPressed(n) && (n.preventDefault(), On(e, t))
      }),
        e.on('keydown', function(n) {
          ...
          t &&
            ...
            (n.preventDefault(), On(e, t))
        })
    },
    Hn = function(e) {
      return function(t) {
        function n(n) {
          return t.setActive(!e.mode.isReadOnly() && !!sn(e, n.element))
        }
        return (
          e.on('NodeChange', n),
          function() {
    ...
    $n = function(r) {
      return function(t) {
        var n = r.dom.getParents(r.selection.getStart())
        t.setDisabled(!an(n))
        function e(n) {
          return t.setDisabled(!an(n.parents))
        }
        return (
          r.on('NodeChange', e),
          function() {
    ...
    Yn = function(t) {
      t.ui.registry.addContextMenu('link', {
        update: function(n) {
          return an(t.dom.getParents(n, 'a')) ? 'link unlink openlink' : 'link'
        },
      })
    },
    Zn = function(i) {
      function n(n) {
        ...
        return n.setDisabled(!sn(i, t)), function() {}
      }
        ...
        commands: [
          {
            ...
            onSetup: function(n) {
              var t = i.selection.getNode()
              return n.setActive(!!sn(i, t)), Hn(i)(n)
            },
            onAction: function(n) {
              var t = sn(i),
                e = n.getValue()
              if (t)
                ...
                var r = { href: e, attach: function() {} },
                  o = ln(i.selection.getContent())
                    ? Q.some(dn(i.selection, t))
                        .filter(function(n) {
                          return 0 < n.length
                        })
                        .or(Q.from(e))
  ...
  !(function nt() {
    r.add('link', function(n) {
      Xn(n), Qn(n), Yn(n), Zn(n), Wn(n), Gn(n), Jn(n)
    })
  })()
})(window)
