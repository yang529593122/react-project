...
!(function() {
  ...
  var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    w = function(t) {
      return t.getParam('link_default_protocol', 'http', 'string')
    },
    r = function(t, e, n) {
      var i,
        o,
      ...
      if ('A' !== t.selection.getNode().tagName) {
        if ((i = t.selection.getRng(!0).cloneRange()).startOffset < 5) {
          ...
          if (((c = l.length), C(i, l, c), y(i, l, c), i.endOffset < 5)) return
          ;(o = i.endOffset), (f = l)
        } else {
          if (3 !== (f = i.endContainer).nodeType && f.firstChild) {
            for (; 3 !== f.nodeType && f.firstChild; ) f = f.firstChild
            3 === f.nodeType && (C(i, f, 0), y(i, f, f.nodeValue.length))
          }
        ...
        !(function(t, e) {
          ...
          ? (0 === i.startOffset ? C(i, f, 0) : C(i, f, o), y(i, f, r))
          : (C(i, f, o), y(i, f, r), (o += 1)),
          '.' === (s = i.toString()).charAt(s.length - 1) && y(i, f, r - 1),
