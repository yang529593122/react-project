...
!(function() {
  ...
  function b(e) {
    return ne.getAttrib(e, 'data-ephox-embed-iri')
  }
  function w(e, t) {
    return (function(e) {
      var t = ne.createFragment(e)
      return '' !== b(t.firstChild)
    })(t)
      ? (function(e) {
          var t = ne.createFragment(e).firstChild
          return {
            type: 'ephox-embed-iri',
            source: b(t),
            altsource: '',
            poster: '',
            width: re.getMaxWidth(t),
            height: re.getMaxHeight(t),
          }
        })(t)
      : (function(n, e) {
          var i = {}
          return (
            ee({
              ...
              start: function(e, t) {
                if (
                  (i.source || 'param' !== e || (i.source = t.map.movie),
                  ('iframe' !== e &&
                    'object' !== e &&
                    'embed' !== e &&
                    'video' !== e &&
                    'audio' !== e) ||
                    (i.type || (i.type = e), (i = Z.extend(t.map, i))),
                  'script' === e)
                ) {
                  var r = v(n, t.map.src)
                  if (!r) return
                ...
                'source' === e &&
                  (i.source
                    ? i.altsource || (i.altsource = t.map.src)
                    : (i.source = t.map.src)),
                  'img' !== e || i.poster || (i.poster = t.map.src)
              },
            }).parse(e),
            (i.source = i.source || i.src || i.data),
            (i.altsource = i.altsource || ''),
            (i.poster = i.poster || ''),
            i
          )
        })(e, t)
  ...
  function x(e, t) {
    var r = ce.createFragment(e).firstChild
    return (
      re.setMaxWidth(r, t.width),
      re.setMaxHeight(r, t.height),
      (function(e) {
        var t = oe()
        return ee(t).parse(e), t.getContent()
      })(r.outerHTML)
    )
  }
  function j(r, e) {
    var n = Z.extend({}, e)
    if (!n.source && (Z.extend(n, w(q(r), n.embed)), !n.source)) return ''
    n.altsource || (n.altsource = ''),
      n.poster || (n.poster = ''),
      (n.source = r.convertURL(n.source, 'source')),
      (n.altsource = r.convertURL(n.altsource, 'source')),
      (n.sourcemime = ie(n.source)),
      (n.altsourcemime = ie(n.altsource)),
      (n.poster = r.convertURL(n.poster, 'poster'))
    var t = (function(t) {
      var e = le.filter(function(e) {
    ...
    if (
      ...
      return se(n.embed, n, !0)
    var i = v(q(r), n.source)
    i &&
      ((n.type = 'script'),
  ...
  function S(e, t) {
    var r = t
      ...
      n = (function(o, a, c) {
        return function(e) {
          ...
          function n(e) {
            return h(e, 'value').bind(function(e) {
              return 0 < e.length ? $.some(e) : $.none()
            })
          }
          var i
          return (
    ...
    return m(
      m(m(m(m({}, n('source')), n('altsource')), n('poster')), n('embed')),
      (function(e, r) {
        var n = {}
        return (
  ...
  function M(i, o) {
    return function(e) {
      if (z(e.url) && 0 < e.url.trim().length) {
        var t = e.html,
          r = C(o, t),
          n = m(m({}, r), { source: e.url, embed: t })
        i.setData(_(n))
      }
    }
  }
  ...
  function F(e, t) {
    ...
    return (
      ...
      (i = new be('span', 1)).attr('class', 'mce-shim'),
      r.append(n),
      r.append(i),
      r
    )
  ...
  var D = function(r) {
    ...
    $ = {
      ...
      none: t,
      from: function(e) {
        return null === e || e === undefined ? u : D(e)
      },
    },
    z = d('string'),
    N = d('object'),
    ...
    ee = tinymce.util.Tools.resolve('tinymce.html.SaxParser'),
    te = tinymce.util.Tools.resolve('tinymce.dom.DOMUtils'),
    re = {
    ...
    oe = tinymce.util.Tools.resolve('tinymce.html.Writer'),
    ae = tinymce.util.Tools.resolve('tinymce.html.Schema'),
    ce = te.DOM,
    ue = ['source', 'altsource'],
    se = function(e, t, r) {
      return (function(e) {
        var t = ce.createFragment(e)
        return '' !== ce.getAttrib(t.firstChild, 'data-ephox-embed-iri')
      })(e)
        ? x(e, t)
        : (function(e, i, o) {
            var a,
                    ...
                    if (o)
                      switch (e) {
                        ...
                        case 'source':
                          if (
                            u < 2 &&
                            (y(t, { src: i[ue[u]], type: i[ue[u] + 'mime'] }),
                            !i[ue[u]])
                          )
                            return
                          u++
                    ...
                    if ('video' === e && o)
                      for (var t = 0; t < 2; t++)
                        if (i[ue[t]]) {
                          ...
                          ;(r.map = {}),
                            u < t &&
                              (y(r, { src: i[ue[t]], type: i[ue[t] + 'mime'] }),
                              c.start('source', r, !0))
                        }
    ...
    fe = function(e, t) {
      ...
      return r
        ? (function(n, i, o) {
            return new me(function(t, e) {
              function r(e) {
                return (
                  e.html && (de[n.source] = e),
                  t({ url: n.source, html: e.html ? e.html : i(n) })
                )
              }
              de[n.source] ? r(de[n.source]) : o({ url: n.source }, r, e)
            })
          })(t, O(e), r)
        : (function(t, r) {
            return new me(function(e) {
              e({ html: r(t), url: t.source })
            })
          })(t, O(e))
    },
    he = function(e) {
    ...
    pe = function(i) {
      ...
      var c = { title: 'Advanced', name: 'advanced', items: a },
        u = [n, o]
      0 < a.length && u.push(c)
      var s = { type: 'tabpanel', tabs: u },
        l = i.windowManager.open({
          ...
          onSubmit: function(e) {
            var t = S(e.getData())
            !(function(e, t, r) {
              ;(t.embed = se(t.embed, t)),
                t.embed && (e.source === t.source || he(t.source))
                  ? k(r, t.embed)
                  : fe(r, t)
                      .then(function(e) {
                        k(r, e.html)
          ...
          onChange: function(e, t) {
            switch (t.name) {
              case 'source':
                !(function(e, t) {
                  var r = S(t.getData(), 'source')
                  e.source !== r.source &&
                    (M(l, i)({ url: r.source, html: '' }),
                    fe(i, r)
                      .then(M(l, i))
                      ['catch'](A(i)))
                })(r.get(), e)
    ...
    be = tinymce.util.Tools.resolve('tinymce.html.Node'),
    we = tinymce.util.Tools.resolve('tinymce.Env'),
    ye = function(i, e) {
      if (!1 === K(i)) return e
      var o,
        a = oe()
    ...
    Oe = function(d) {
      d.on('preInit', function() {
        ...
        Z.each('video audio iframe object'.split(' '), function(e) {
          t[e] = new RegExp('</' + e + '[^>]*>', 'gi')
        })
        ...
        t.on('ObjectResized', function(e) {
          ...
          r.getAttribute('data-mce-object') &&
            ...
            r.setAttribute(
              'data-mce-html',
              escape(
                se(t, { width: String(e.width), height: String(e.height) })
              )
            ))
        })
    },
  ...
  !(function Ce() {
    n.add('media', function(e) {
      return ve(e), Ae(e), Se(e), Oe(e), _e(e), ge(e)
    })
  })()
})()
