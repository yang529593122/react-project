...
!(function(r) {
  ...
  function S(e) {
    return 0 === e.length ? He.none() : He.some(e[0])
  }
  function O(e) {
    return 0 === e.length ? He.none() : He.some(e[e.length - 1])
  }
  function C(e, n, t) {
  ...
  function A(e, n, t) {
    return e.isSome() && n.isSome()
      ? He.some(t(e.getOrDie(), n.getOrDie()))
      : He.none()
  }
  function x(e) {
    return He.from(e.dom().parentNode).map(Ln.fromDom)
  }
  function R(e) {
  ...
  function I(e, n) {
    ...
    return He.from(t[n]).map(Ln.fromDom)
  }
  function B(e) {
    return I(e, 0)
  }
  ...
  function H(e, n) {
    return (function(e, n) {
      for (
        var t = n !== undefined && null !== n ? n : In, r = 0;
  ...
  function W(e) {
    ...
    return Mn.grep(
      (function(t, e) {
        var n = Mn.map(e, function(e) {
          var n = t.dom.getParent(e, 'li,dd,dt', Gn(t, e))
          return n || e
        })
        return _n.unique(n)
      })(e, n),
  ...
  function V(e, n) {
    var t = e.dom.getParents(n, 'ol,ul', Gn(e, n))
    return O(t)
  }
  function K(e, n) {
    var t,
    ...
    if (
      (s &&
        ((r = i.create(s)).tagName === s.toUpperCase() &&
          i.setAttribs(r, tt(e)),
        Xn(n.firstChild, u) || a.appendChild(r)),
      n)
    )
      for (; (t = n.firstChild); ) {
        var c = t.nodeName
        o ||
          ...
          Xn(t, u)
            ...
            : s
            ? (r || ((r = i.create(s)), a.appendChild(r)), r.appendChild(t))
            : a.appendChild(t)
      }
    return (
      s
        ? o || r.appendChild(i.create('br', { 'data-mce-bogus': '1' }))
        : a.appendChild(i.create('br')),
      a
    )
  }
  function X(e) {
  ...
  function z(e, n) {
    var t = e.dom()
    !(function(e, n) {
      for (var t = Rn(e), r = 0, o = t.length; r < o; r++) {
        var i = t[r]
        n(e[i], i)
      }
    })(n, function(e, n) {
  ...
  function Y(e, n, t) {
    ...
    !(function(e) {
      return e.style !== undefined && Ve(e.style.getPropertyValue)
    ...
    return (
      O(r).each(function(e) {
        !(function(e, n) {
          ...
          e,
          (function(e, n, t) {
            var r = Ln.fromTag('li', e)
            return z(r, n), U(r, t), r
          })(n, t.itemAttributes, t.content)
        ),
          (function(e, n) {
            X(e.list) !== n.listType && (e.list = J(e.list, n.listType)),
              z(e.list, n.listAttributes)
          })(e, t)
      }),
      r
    )
    ...
    p(t, function(n, e) {
      ;(function(e, n) {
        for (var t = e[n].depth, r = n - 1; 0 <= r; r--) {
          if (e[r].depth === t) return He.some(e[r])
        ...
        !(function(e, n) {
          ;(e.listType = n.listType),
            (e.listAttributes = Ye({}, n.listAttributes))
        })(n, e)
      })
    })
  }
  ...
  function de(e) {
    var n = g(Zn.getSelectedListItems(e), Ln.fromDom)
    return A(
      N(n, t(re)),
      N(
        (function(e) {
  ...
  function le(t, e, r) {
    var n = (function(e, n) {
      var t = Ge(!1)
      return g(e, function(e) {
        return { sourceList: e, entries: ot(0, n, t, e) }
      })
    })(e, de(t))
    p(n, function(e) {
      !(function(e, n) {
  ...
  function ve(e, n) {
    var t = g(Zn.getSelectedListRoots(e), Ln.fromDom),
      r = g(Zn.getSelectedDlItems(e), Ln.fromDom),
      o = !1
  ...
  function Te(r, o, i) {
    ...
    var e,
      ...
      u = 'LI',
      t = Zn.getClosestListRootElm(r, r.selection.getStart(!0)),
      a = r.dom
    'false' !== a.getContentEditable(r.selection.getNode()) &&
      ...
      Mn.each(
        (function(t, e, r) {
          ...
          return (
            Mn.each(s, function(e) {
              if (Kn(t, e)) return i.push(e), void (o = null)
              if (u.isBlock(e) || Wn(e))
                return Wn(e) && u.remove(e), void (o = null)
              var n = e.nextSibling
              ct.isBookmarkNode(e) && (Kn(t, n) || (!n && e.parentNode === r))
                ? (o = null)
                : (o ||
                    ((o = u.create('p')),
        ...
        function(e) {
          ...
          (function(e, n, t) {
            ...
            ? ((n = t), (e = a.rename(e, u)), t.appendChild(e))
            : ((n = a.create(o)),
  ...
  function Ee(n, e, t, r, o) {
    if (e.nodeName !== r || gt(o)) {
      var i = dt(n.selection.getRng(!0))
  ...
  function we(e, n) {
    ...
    'LI' === r.nodeName &&
      ...
      ((t = r.previousSibling) && 'LI' === t.nodeName
        ? (t.appendChild(n), Qn(e, r) && vt.remove(r))
        : vt.setStyle(r, 'listStyleType', 'none')),
      Fn(r) &&
        (t = r.previousSibling) &&
        'LI' === t.nodeName &&
        t.appendChild(n)
  ...
  function ke(e, n, t, r) {
    var o = n.startContainer,
      i = n.startOffset
    if (Un(o) && (t ? i < o.data.length : 0 < i)) return o
    var u = e.schema.getNonEmptyElements()
    1 === o.nodeType && (o = kn.getNode(o, i))
    var a = new An(o, r)
    for (t && zn(e.dom, o) && a.next(); (o = a[t ? 'next' : 'prev2']()); ) {
      if ('LI' === o.nodeName && !o.hasChildNodes()) return o
      if (u[o.nodeName]) return o
      if (Un(o) && 0 < o.data.length) return o
    }
  }
  function Ae(e, n) {
    var t = n.childNodes
    return 1 === t.length && !Fn(t[0]) && e.isBlock(t[0])
  }
  function xe(e, n, t) {
    var r, o
    if (
  ...
  function Re(n, e, t) {
    ...
    if (Yn(n, e) && Yn(n, t)) {
      Fn(t.lastChild) && (o = t.lastChild),
        ...
        xe(n, e, t),
        o && t.appendChild(o)
      var u = En(Ln.fromDom(t), Ln.fromDom(e)) ? n.getParents(e, Fn, t) : []
      n.remove(e),
        p(u, function(e) {
  ...
  function Ie(e, n, t, r) {
    ...
    if (o.isEmpty(r))
      ...
      var i = dt(n)
      Re(o, t, r), e.selection.setRng(lt(i))
    }
  }
  function Be(e, n) {
    var t = e.dom,
      r = e.selection,
      o = r.getStart(),
      i = Zn.getClosestListRootElm(e, o),
      u = t.getParent(r.getStart(), 'LI', i)
    if (u) {
      var a = u.parentNode
      if (a === e.getBody() && Qn(t, a)) return !0
      var s = st(r.getRng()),
        c = t.getParent(ke(e, s, n, i), 'LI', i)
      if (c && c !== u)
        return (
    ...
    return (
      ...
      (function(e, n) {
        var t = e.dom,
          ...
          o = Zn.getClosestListRootElm(e, r),
          i = t.getParent(r, t.isBlock, o)
        if (i && t.isEmpty(i)) {
          var u = st(e.selection.getRng()),
            a = t.getParent(ke(e, u, n, o), 'LI', o)
          if (a)
            return (
              e.undoManager.transact(function() {
                !(function(e, n, t) {
                  ...
                  pt.mergeWithAdjacentLists(t, a.parentNode),
    ...
    return e.selection.isCollapsed()
      ...
      : (function(e) {
          var n = e.selection.getStart(),
            t = Zn.getClosestListRootElm(e, n)
          return (
            !!(
              e.dom.getParent(n, 'LI,DT,DD', t) ||
              0 < Zn.getSelectedListItems(e).length
            ) &&
            (e.undoManager.transact(function() {
              e.execCommand('Delete'), ht(e.dom, e.getBody())
            }),
            !0)
          )
        })(e)
  ...
  var Fe,
    ...
    He = {
      ...
      none: n,
      from: function(e) {
        return null === e || e === undefined ? s : je(e)
      },
    },
    $e = m('string'),
    qe = m('array'),
    ...
    sn = {
      unknown: function() {
        return an({ current: undefined, version: en.unknown() })
      },
      nu: an,
      edge: l(nn),
      chrome: l(tn),
    ...
    On = { browsers: l(yn), oses: l(Sn) },
    Cn = Ge(
      (function(e, n) {
        var t = On.browsers(),
          r = On.oses(),
          o = vn(t, e).fold(sn.unknown, sn.nu),
          i = hn(r, e).fold(pn.unknown, pn.nu)
        return {
          browser: o,
          os: i,
          deviceType: (function(e, n, t, r) {
            var o = e.isiOS() && !0 === /ipad/i.test(t),
              ...
              s = o || (!i && u && r('(min-device-width:768px)')),
              c = i || (u && !s),
    ...
    Ln = {
      fromHtml: function(e, n) {
        ...
        if (((t.innerHTML = e), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (r.console.error('HTML does not have a single root node', e),
      ...
      fromPoint: function(e, n, t) {
        var r = e.dom()
        return He.from(r.elementFromPoint(n, t)).map(bn)
      },
    },
    Tn =
    ...
    Dn =
      ...
      Tn),
    En = Cn.get().browser.isIE()
      ? function(e, n) {
          return Qe(e.dom(), n.dom())
        }
      : function(e, n) {
          var t = e.dom(),
            r = n.dom()
    ...
    kn = tinymce.util.Tools.resolve('tinymce.dom.RangeUtils'),
    An = tinymce.util.Tools.resolve('tinymce.dom.TreeWalker'),
    xn = tinymce.util.Tools.resolve('tinymce.util.VK'),
    Rn = Object.keys,
    In =
      ((function() {
        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n]
    ...
    Pn = function(e) {
      return (function(e) {
        return Bn('HTMLElement', e)
      })(H('ownerDocument.defaultView', e)).prototype.isPrototypeOf(e)
    },
    _n = tinymce.util.Tools.resolve('tinymce.dom.DomQuery'),
    Mn = tinymce.util.Tools.resolve('tinymce.util.Tools'),
    Un = function(e) {
    ...
    Zn = {
      ...
      getSelectedSubLists: function(e) {
        ...
        return (function(e, n) {
          ...
          ? (function(e) {
              return Mn.grep(e.querySelectorAll('ol,ul,dl'), function(e) {
                return Fn(e)
              })
            })(n)
      ...
      getSelectedListRoots: function(e) {
        var n = (function(e) {
          var n = V(e, e.selection.getStart()),
            t = v(e.selection.getSelectedBlocks(), jn)
    ...
    nt = function(e) {
      var n = e.getParam('forced_root_block', 'p')
      return !1 === n ? '' : !0 === n ? 'p' : n
    },
    tt = function(e) {
    ...
    at = function(e, n, t) {
      var r, o, i, u, a, s
      for (
        i = ut.select('span[data-mce-type="bookmark"]', n),
          a = K(e, t),
          (r = ut.createRng()).setStartAfter(t),
          r.setEndAfter(n),
      ...
      e.dom.isEmpty(o) || ut.insertAfter(o, n),
        ut.insertAfter(a, n),
    ...
    ct = tinymce.util.Tools.resolve('tinymce.dom.BookmarkManager'),
    ft = it.DOM,
    dt = function(o) {
      function e(e) {
        var n, t, r
        ;(t = o[e ? 'startContainer' : 'endContainer']),
          ...
          1 === t.nodeType &&
            ((n = ft.create('span', { 'data-mce-type': 'bookmark' })),
            t.hasChildNodes()
              ? ((r = Math.min(r, t.childNodes.length - 1)),
                e
                  ? t.insertBefore(n, t.childNodes[r])
                  : ft.insertAfter(n, t.childNodes[r]))
              : t.appendChild(n),
            (t = n),
            (r = 0)),
    ...
    pt = {
      toggleList: function(e, n, t) {
        var r = Zn.getParentList(e),
          o = Zn.getSelectedSubLists(e)
        ;(t = t || {}),
          r && 0 < o.length
            ? Ee(e, r, o, n, t)
            : (function(e, n, t, r) {
                if (n !== e.getBody())
                  if (n)
                    if (n.nodeName !== t || gt(r) || Se(n)) {
                      var o = dt(e.selection.getRng(!0))
                      be(e.dom, n, r)
                      var i = e.dom.rename(n, t)
                      mt(e.dom, i), e.selection.setRng(lt(o)), j(e, Oe(t), i)
                    } else ye(e)
                  else Te(e, t, r), j(e, Oe(t), n)
              })(e, r, n, t)
      },
      mergeWithAdjacentLists: mt,
    },
    vt = it.DOM,
    ht = function(n, e) {
    ...
    Nt = function(n) {
      n.on('keydown', function(e) {
        e.keyCode === xn.BACKSPACE
          ? _e(n, !1) && e.preventDefault()
          : e.keyCode === xn.DELETE && _e(n, !0) && e.preventDefault()
      })
    },
    yt = _e,
    St = function(n) {
