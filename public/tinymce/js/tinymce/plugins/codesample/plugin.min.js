...
!(function(e) {
  ...
  var f = {
      isCodeSample: function q(e) {
        return (
          e && 'PRE' === e.nodeName && -1 !== e.className.indexOf('language-')
        )
      },
      trimArg: function I(t) {
        return function(e, n) {
          return t(n)
        }
      },
    },
    h = 'undefined' != typeof e.window ? e.window : Function('return this;')(),
    b = {},
    y = { exports: b },
    w = {}
  !(function(n, t, r, p) {
    ...
    ;(window.Prism = { manual: !0 }),
      (function(e) {
        if ('object' == typeof t && void 0 !== r) r.exports = e()
              ...
              function(e, t, n) {
                ;(function(e) {
                  var n = (function(u) {
                      ...
                      E = {
                        ...
                        util: {
                          encode: function(e) {
                            return e instanceof O
                              ? new O(e.type, E.util.encode(e.content), e.alias)
                              : Array.isArray(e)
                              ? e.map(E.util.encode)
                              : e
                                  .replace(/&/g, '&amp;')
                          ...
                          clone: function s(e, t) {
                            ...
                            switch (((t = t || {}), a)) {
                              case 'Object':
                                if (((n = E.util.objId(e)), t[n])) return t[n]
                                for (var i in ((r = {}), (t[n] = r), e))
                                  e.hasOwnProperty(i) && (r[i] = s(e[i], t))
                                return r
                              case 'Array':
                                return (
                                  (n = E.util.objId(e)),
                        ...
                        languages: {
                          ...
                          insertBefore: function(t, e, n, r) {
                            ...
                            return (
                              (r[t] = i),
                              E.languages.DFS(E.languages, function(e, n) {
                                n === l && e != t && (this[e] = i)
                              }),
                              i
                            )
                        ...
                        highlightAllUnder: function(e, n, t) {
                          ...
                          E.hooks.run('before-highlightall', r),
                            (r.elements = Array.prototype.slice.apply(
                              r.container.querySelectorAll(r.selector)
                            )),
                            E.hooks.run('before-all-elements-highlight', r)
                          for (var a, i = 0; (a = r.elements[i++]); )
                            E.highlightElement(a, !0 === n, r.callback)
                        },
                        highlightElement: function(e, n, t) {
                          ...
                          function o(e) {
                            ;(s.highlightedCode = e),
                              E.hooks.run('before-insert', s),
                              (s.element.innerHTML = s.highlightedCode),
                              E.hooks.run('after-highlight', s),
                              E.hooks.run('complete', s),
                              t && t.call(s.element)
                          }
                          if ((E.hooks.run('before-sanity-check', s), !s.code))
                            return (
                              E.hooks.run('complete', s),
                              void (t && t.call(s.element))
                            )
                          if ((E.hooks.run('before-highlight', s), s.grammar))
                            if (n && u.Worker) {
                              var l = new Worker(E.filename)
                            ...
                            } else o(E.highlight(s.code, s.grammar, s.language))
                          else o(E.util.encode(s.code))
                        },
                        highlight: function(e, n, t) {
                          ...
                          return (
                            ...
                            O.stringify(E.util.encode(r.tokens), r.language)
                          )
                        },
                        matchGrammar: function(e, n, t, r, a, i, s) {
                          for (var o in t)
                              ...
                              for (var u = 0; u < l.length; ++u) {
                                ...
                                for (
                                  ...
                                  if (!(w instanceof O)) {
                                    ...
                                    if (F) {
                                      d && (m = F[1] ? F[1].length : 0)
                                      k =
                                        (v = F.index + m) +
                                        (F = F[0].slice(m)).length
                                      var S = w.slice(0, v),
                                        j = w.slice(k),
                                        $ = [b, P]
                        ...
                        tokenize: function(e, n) {
                          ...
                          return E.matchGrammar(e, t, n, 0, 0, !1), t
                        },
                        hooks: {
                          all: {},
                          add: function(e, n) {
                    ...
                    if (
                      ...
                      (O.stringify = function(e, n) {
                        ...
                        if (e.alias) {
                          ...
                          Array.prototype.push.apply(t.classes, r)
                        }
                        E.hooks.run('wrap', t)
                        var a = Object.keys(t.attributes)
                          .map(function(e) {
                            return (
                              e +
                              '="' +
                    ...
                    var e = E.util.currentScript()
                    if (
                      (e &&
                        ((E.filename = e.src),
                        e.hasAttribute('data-manual') && (E.manual = !0)),
                      !E.manual)
                    ) {
                      var t = function() {
                                ...
                                if (
                                  ...
                                  if (-1 < o) {
                                    ...
                                    var l = i.substring(0, o),
                                      u = new y.Token(
                                        g,
                                        y.tokenize(a, d.grammar),
                                        'language-' + g,
                                        a
                                      ),
                                      c = i.substring(o + s.length),
                                      p = []
                                    l && p.push.apply(p, h([l])),
                                      p.push(u),
                                      c && p.push.apply(p, h([c])),
                                      'string' == typeof t
                                        ? e.splice.apply(e, [n, 1].concat(p))
                                        : (t.content = p)
                                  }
    ...
    var a = window.Prism
    window.Prism = e
  })(undefined, b, y, undefined)
  function v(e) {
    var n = e.selection ? e.selection.getNode() : null
    return f.isCodeSample(n) ? g.some(n) : g.none()
  }
  var k,
    x = y.exports.boltExport,
    _ = function(e) {
      return e.getParam('codesample_languages')
    },
    A = function(e) {
      return e.getParam('codesample_global_prismjs', !1, 'boolean')
    },
    F = function(e) {
      return h.Prism && A(e) ? h.Prism : x
    },
    P = v,
    S = function(n, t, r) {
      n.undoManager.transact(function() {
        ...
        return (
          ...
          e.fold(
            function() {
              n.insertContent(
                '<pre id="__new" class="language-' + t + '">' + r + '</pre>'
              ),
    ...
    z =
      ...
      function(t) {
        var e = $(t),
          n = (function(e) {
            return 0 === e.length ? g.none() : g.some(e[0])
          })(e).fold(
            function() {
              return ''
            },
        ...
        t.windowManager.open({
          ...
          onSubmit: function(e) {
            var n = e.getData()
            S(t, n.language, n.code), e.close()
          },
        })
      }),
    N = function(n) {
      n.addCommand('codesample', function() {
        var e = n.selection.getNode()
        n.selection.isCollapsed() || f.isCodeSample(e)
          ? z(n)
          : n.formatter.toggle('code')
      })
    },
    T = function(t) {
      var a = t.$
      t.on('PreProcess', function(e) {
        a('pre[contenteditable=false]', e.node)
          .filter(f.trimArg(f.isCodeSample))
          .each(function(e, n) {
            var t = a(n),
              r = n.textContent
    ...
    B = function(t) {
      t.ui.registry.addToggleButton('codesample', {
        icon: 'code-sample',
          ...
          function n() {
            e.setActive(
              (function(e) {
                ...
                return e.dom.is(n, 'pre[class*="language-"]')
              })(t)
            )
          }
          return (
        ...
        t.ui.registry.addMenuItem('codesample', {
          text: 'Code sample...',
          icon: 'code-sample',
          onAction: function() {
            return z(t)
