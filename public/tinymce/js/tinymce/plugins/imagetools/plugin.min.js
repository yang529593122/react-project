...
!(function(v) {
  ...
  var Re = function(e, n) {
    ...
    Ye = { browsers: d(We), oses: d(Ge) },
    Ve = r(
      (function(e, n) {
        var t = Ye.browsers(),
          r = Ye.oses(),
          o = qe(t, e).fold(ke.unknown, ke.nu),
          i = $e(r, e).fold(He.unknown, He.nu)
        return {
          browser: o,
          os: i,
